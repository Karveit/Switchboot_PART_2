...
void savemeta_to_sdcard(){dump_to_sd(3);}
...
ment_t ment_tools[] = {
	MDEF_BACK(),
	MDEF_CHGLINE(),
	MDEF_CAPTION("-- Choose folder --", 0xFF00FF00),
	...
	//MDEF_HANDLER("Dump emmc savemeta files", savemeta_to_sdcard),
...
menu_t menu_top = {
	ment_top,
	"Switchboot v1.3.3 - Hekate v4.10.1", 0, 0
};
