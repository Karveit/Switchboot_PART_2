...
void launch_tools_payload_root() {launch_tools(1); }
void launch_tools_auto_payload(){launch_tools(2); }
void launch_tools_auto_payload_root() {launch_tools(3); }
void launch_tools_module() {launch_tools(4); }
...
ment_t ment_options[] = {
	...
	MDEF_CHGLINE(),
	MDEF_HANDLER("Add payload to hekate_ipl.ini (/payloads)", launch_tools_auto_payload),
	MDEF_HANDLER("Add payload to hekate_ipl.ini (SD ROOT)", launch_tools_auto_payload_root),
	MDEF_END()
};
...
ment_t ment_launch[] = {
	MDEF_BACK(),
	MDEF_CHGLINE(),
	MDEF_CAPTION("-- Payload Menu --", 0xFF00FF00),
	MDEF_CHGLINE(),
	MDEF_HANDLER("Launch payload from payloads folder", launch_tools_payload),
	MDEF_HANDLER("Launch payload from SD root", launch_tools_payload_root),
	MDEF_END()
};
...
menu_t menu_top = {
	ment_top,
	"Switchboot v1.20 - Hekate CTCaer v4.9.1", 0, 0
};
