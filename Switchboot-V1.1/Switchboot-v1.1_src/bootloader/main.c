...
ment_t ment_launch[] = {
	...
	MDEF_CHGLINE(),
	//MDEF_CAPTION("-- Payloads folder --", 0xFF00FF00),
	MDEF_HANDLER("Launch payload from payloads folder", launch_tools_payload),
	//MDEF_HANDLER("Autoboot payload (add to ini)", launch_tools_auto_payload),
	//MDEF_CHGLINE(),
	//MDEF_CAPTION("-- SD Root --", 0xFF00FF00),
	MDEF_HANDLER("Launch payload from SD root", launch_tools_payload_root),
	//MDEF_HANDLER("Autoboot payload (add to ini)", launch_tools_auto_payload_root),
	MDEF_END()
};
...
menu_t menu_top = {
	ment_top,
	"Switchboot v1.10 - Hekate CTCaer v4.9.1", 0, 0
};
