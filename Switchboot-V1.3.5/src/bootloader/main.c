...
ment_t ment_tools[] = {
	...
	MDEF_CHGLINE(),
	MDEF_HANDLER("Select Backup Folder 1 (BACKUP_1)", select_folder_1),
	MDEF_HANDLER("Select Backup Folder 2 (BACKUP_2)", select_folder_2),
	MDEF_HANDLER("Select Backup Folder 3 (BACKUP_3)", select_folder_3),
	MDEF_HANDLER("Select Backup Folder 4 (BACKUP_4)", select_folder_4),
	MDEF_HANDLER("Select Backup Folder 5 (BACKUP_5)", select_folder_5),
	MDEF_CHGLINE(),
	MDEF_CAPTION("-- Misc --", 0xFF00FF00),
...
menu_t menu_top = {
	ment_top,
	"Switchboot v1.3.5 - Hekate v4.10.1", 0, 0
};
