...
void *tui_do_menu(menu_t *menu)
{
	...
	while (true)
	{
		...
		gfx_printf("Fuse: %d - Max. FW ", burntFuses);
		if (burntFuses == 1){
		gfx_printf("v1.0.0\n");
		} else if (burntFuses == 2){
		gfx_printf("v2.3.0\n");
		} else if (burntFuses == 3){
		gfx_printf("v3.0.0\n");
		} else if (burntFuses == 4){
		gfx_printf("v3.0.2\n");
		} else if (burntFuses == 5){
		gfx_printf("v4.1.0\n");
		} else if (burntFuses == 6){
		gfx_printf("v5.1.0\n");
		} else if (burntFuses == 7){
		gfx_printf("v6.1.0\n");
		} else if (burntFuses == 8){
		gfx_printf("v6.2.0\n");
		} else if (burntFuses == 9){
		gfx_printf("v8.0.1\n");
		}
